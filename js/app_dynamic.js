...
//Getting the list of new plot variable from PlotVar file
var PlotVar2,plotVarDef2;
...
var RuralUrban = ["urban1","rural1","total1","urban2","rural2","total2","urban3","rural3","total3","urban4","rural4","total4","urban5","rural5","total5","urban6","rural6","total6","urban7","rural7","total7","urban8","rural8","total8","urban9","rural9","total9","urban10","rural10","total10","urban11","rural11","total11","urban12","rural12","total12","urban13","rural13","total13","urban14","rural14","total14","urban15","rural15","total15","urban16","rural16","total16","urban17","rural17","total17","urban18","rural18","total18","urban19","rural19","total19","urban20","rural20","total20","urban21","rural21","total21","urban22","rural22","total22","urban23","rural23","total23","urban24","rural24","total24","urban25","rural25","total25","urban26","rural26","total26","urban27","rural27","total27","urban28","rural28","total28","urban29","rural29","total29","urban30","rural30","total30","urban31","rural31","total31","urban32","rural32","total32","urban33","rural33","total33","urban34","rural34","total34","urban35","rural35","total35","urban36","rural36","total36","urban37","rural37","total37","urban38","rural38","total38","urban39","rural39","total39","urban40","rural40","total40","urban41","rural41","total41","urban42","rural42","total42","urban43","rural43","total43","urban44","rural44","total44","urban45","rural45","total45","urban46","rural46","total46","urban47","rural47","total47","urban48","rural48","total48","urban49","rural49","total49","urban50","rural50","total50","urban51","rural51","total51","urban52","rural52","total52","urban53","rural53","total53","urban54","rural54","total54","urban55","rural55","total55","urban56","rural56","total56","urban57","rural57","total57","urban58","rural58","total58","urban59","rural59","total59","urban60","rural60","total60","urban61","rural61","total61","urban62","rural62","total62","urban63","rural63","total63","urban64","rural64","total64","urban65","rural65","total65","urban66","rural66","total66","urban67","rural67","total67","urban68","rural68","total68","urban69","rural69","total69","urban70","rural70","total70","urban71","rural71","total71","urban72","rural72","total72","urban73","rural73","total73","urban74","rural74","total74","urban75","rural75","total75","urban76","rural76","total76","urban77","rural77","total77","urban78","rural78","total78","urban79","rural79","total79","urban80","rural80","total80","urban81","rural81","total81","urban82","rural82","total82","urban83","rural83","total83","urban84","rural84","total84","urban85","rural85","total85","urban86","rural86","total86","urban87","rural87","total87","urban88","rural88","total88","urban89","rural89","total89","urban90","rural90","total90","urban91","rural91","total91","urban92","rural92","total92","urban93","rural93","total93"];

/*
Below 3 are the call to the data dictionary , Map Plot Variables and Plot variables definitions
*/
d3.json('../json/dictionary1.json',function(error, data){
    if(error) throw error;
    var healthcare = $("#HEALTHCARE_1_DROPDOWN");
    var li,a,id,count=0;
    for(var prop in data){
        if(data.hasOwnProperty(prop)){
            count++;
            healthcare.append('<li><a id="HEALTH_VAR_2" class="HEALTH_VAR_2_SELECT display_c" onclick="HEALTH_VAR_2_SELECT('+prop+')" name="'+ prop +'" style="text-decoration:none;">'+data[prop]+'</a></li>');
        }
    }
    console.log("New variables : "+count);
});
d3.json('../json/PlotVars.json',function(error,data){
    if(error){
        
    }else{
        PlotVar2 = data;
        console.log(PlotVar2);
    }
});
d3.json('../json/PlotVarsDef.json',function(error,data){
    if(error){
        
    }else{
        plotVarDef2 = data;
        console.log(plotVarDef2);
    }
});

function HEALTH_VAR_2_SELECT(varNum){
    console.log("Clicked : ",varNum);
    
            $("#legHead").hide()
            $("#sub-info").addClass("col-border");
            $("#sub-info").show();
            $("#sub-info-q").hide();
            $("#health_var_2_tabs").show();
            $("#index_tabs").hide();
            $("#non_index_tabs").hide();
           ...
           currentCategoryPlot = "rural"+varNum;
            ...
            plotMap(2,currentStatePlot,currentCategoryPlot);
            //createState(currentStatePlot,currentCategoryPlot); 
}
...
var plotVarDef = {
   ...
   "quality" : {
    ...
    rural_urban :{
       limit : {
            l1 : {
                l : 60, r : 80 , c : "#045A8D" , head : ""
            },
            l2 : {
                l : 40, r : 60 , c : "#2B8CBE" , head : ""
            }, 
            l3 : {
                l : 21, r : 40 , c : "#FFC107" , head : ""
            },
            l4 : {
                l : 0, r : 20 , c : "#E65100" , head : ""
            }
        },
        description : {
            main_head : "Rural45",
            category_head : "Rural45",
            leg_head : "",
            desc : ""
        }
    }
...
function generateStates(stateCallCode,mapCallCode){
        ...
        $(".HEALTH_2_SELECT_AREA").on('click',function(){
            
            MainHeading.text("Generating Maps...");
            $("#legHead").hide()
            $("#sub-info").addClass("col-border");
            $("#sub-info").show();
            $("#sub-info-q").hide();
            
            //Getting the categoryType
            console.log($(this).attr('id')+currentCategoryPlot[5]);
            currentCategoryPlot = $(this).attr('id')+currentCategoryPlot[5];
       ...
       function create(stateNameCall,categoryCall){
        ...
        apiVAR = [];
        //Creating the data_vars for the API (Check from PlotCategory and PlotVar2)
        if(PlotCategory[categoryCall] != undefined){
           PlotCategory[categoryCall].reqVar.forEach(function(d){
            ...
            PlotVar2[categoryCall].reqVar.forEach(function(d){
            ...
            plotVar = PlotVar2[categoryCall].plotVar;
        } 
        
        //@@QUICKFIX
        if(PlotVar2 != undefined && PlotVar2[categoryCall] != undefined && PlotVar2[categoryCall].plotType == 'healthvar_2_percent'){
        ...
        if(PlotVar2 != undefined && PlotVar2[categoryCall] != undefined && PlotVar2[categoryCall].plotType == 'healthvar_2_percent'){
            ...
            $.ajax({
              type: 'POST',
              url: 'http://localhost:8080/stateVar2',
            ...
            if(stateAPIData!=null && STATEDistrictTopo!=null){
                if(PlotVar2 != undefined && PlotVar2[categoryCall] != undefined && PlotVar2[categoryCall].plotType == 'healthvar_2_percent'){
                    ...
                    if(currentStatePlot == 'India' || currentStatePlot == 'India_state'){
                       Plot_Health_var_2_IndiaDistMAP(STATEDistrictTopo,stateAPIData);
                    }else{
                       Plot_Health_var_2_StateDistMAP(STATEDistrictTopo,stateAPIData);
                    }
                }else if(PlotCategory[categoryCall].plotType == "NON_COMP_QUALITY" || stateNameCall == 'India_state' || PlotCategory[categoryCall].plotType == "QUALITY_INDEX"){
                    if(canvas) canvas.remove();
     ...
     function Plot_Health_var_2_StateDistMAP(STATEDistrictTopo,stateAPIData){
        ...
        dynamicPlotPercentage();
          //Sample data to plot will be deleted lat    
        function dynamicPlotPercentage()
            {
                
                console.log("India Map:: New Variables Plot : "+plotVar.v);
                
                InfoRuralPopulation.style("font-size",(fontSize*infoBoxPopulationFontRatio)+'px')
                InfoRuralTribalPopulation.style("font-size",(fontSize*infoBoxPopulationFontRatio)+'px')
                InfoUrbanPopulation.style("font-size",(fontSize*infoBoxPopulationFontRatio)+'px')
                
                console.log("This is the new plot var : ",plotVarDef2)
                MainHeading.text(plotVarDef2[plotVar.v].description.main_head +" : INDIA")
            ...
            outlineMap = g.append("g")
             ...
             outlineMap
                  ...
                  .style('fill',function(d,i){
                    ...
                    if(d == undefined || d.properties[plotVar.v] == undefined || d.properties[plotVar.v] == "*" || d.properties[plotVar.v] == " "){
                        return '#777'//colorAccessSubCenter_STATE_gt_5km[4];
                    }
                    else if(d.properties[plotVar.v] >= plotVarDef2[plotVar.v].limit.l4.l && d.properties[plotVar.v]< plotVarDef2[plotVar.v].limit.l4.r){
                        console.log(d.properties[plotVar.v]);
                        return plotVarDef2[plotVar.v].limit.l4.c;
                    }else if(d.properties[plotVar.v] >= plotVarDef2[plotVar.v].limit.l3.l && d.properties[plotVar.v] <plotVarDef2[plotVar.v].limit.l3.r){
                        //console.log(d.properties[plotVar.v]);
                        return plotVarDef2[plotVar.v].limit.l3.c;
                    }else if(d.properties[plotVar.v] >= plotVarDef2[plotVar.v].limit.l2.l  && d.properties[plotVar.v]<plotVarDef2[plotVar.v].limit.l2.r){
                        //console.log(d.properties[plotVar.v]);
                        return plotVarDef2[plotVar.v].limit.l2.c;
                    }else if(d.properties[plotVar.v] >= plotVarDef2[plotVar.v].limit.l1.l ){
                        //console.log(d.properties[plotVar.v]);
                        return plotVarDef2[plotVar.v].limit.l1.c;
                    }
                    else{
                        //console.log(d.properties[plotVar.v]);
                        return '#000'
               ...
               /*.on('mouseover',function(d){
                    if(d.properties.ST_NM == "Andhra Pradesh"){
                        MainHeading.text(plotVarDef2[plotVar.v].description.main_head + " : " +"Andhra Pradesh*")
                        //InfoStateName.text("Andhra Pradesh*".toUpperCase())
                    }else 
                    if(d.properties.ST_NM.toUpperCase() == 'NCT OF DELHI' || d.properties.ST_NM.toUpperCase() == 'DELHI'){
                         MainHeading.text(plotVarDef2[plotVar.v].description.main_head + " : " +"Delhi")
                        //InfoStateName.text("Delhi".toUpperCase())
                    }else if(d.properties.ST_NM.toUpperCase() == 'ARUNANCHAL PRADESH'){
                        MainHeading.text(plotVarDef2[plotVar.v].description.main_head + " : " +"Arunachal Pradesh")
                        //InfoStateName.text("Arunachal Pradesh".toUpperCase())
                    }else{
                        MainHeading.text(plotVarDef2[plotVar.v].description.main_head + " : " + d.properties.ST_NM)
                        //InfoStateName.text(d.properties.ST_NM.toUpperCase())
                    }
                    d3.select(this).style('opacity',"0.6")
                     ...
                     if(d == undefined || d.properties[PlotCategory[categoryCall].reqVar[0].v] ==undefined ){
                        ...
                        InfoHealthCategoryName.text(plotVarDef2[plotVar.v].description.category_head)
                        InfoExisting
                              .transition()
                              .duration(200)
                              .style('width',function(){
                    ...
                    MainHeading.text(plotVarDef2[plotVar.v].description.main_head)
                    d3.select(this).style('opacity',"1")
                ...
                if(currentCategoryPlot == "SDH_AVL" || currentCategoryPlot == "DH_AVL"){
                    ...
                    d3.select("#legHead").text(plotVarDef2[plotVar.v].description.leg_head);
                    d3.select("#l1").text(plotVarDef2[plotVar.v].limit.l1.head);
                    d3.select("#l2").text(plotVarDef2[plotVar.v].limit.l2.head);
                    d3.select("#l3").text(plotVarDef2[plotVar.v].limit.l3.head);
                    d3.select("#l4").text(plotVarDef2[plotVar.v].limit.l4.head);
                
                if(plotVarDef2[plotVar.v].limit.l1.r == 100){
                    d3.select("#d4").text("< "+plotVarDef2[plotVar.v].limit.l4.r+"%");
                    d3.select("#d3").text(plotVarDef2[plotVar.v].limit.l3.l+"% - "+ plotVarDef2[plotVar.v].limit.l3.r+"%");
                    d3.select("#d2").text(plotVarDef2[plotVar.v].limit.l2.l+"% - "+ plotVarDef2[plotVar.v].limit.l2.r+"%");
                    d3.select("#d1").text("> " + plotVarDef2[plotVar.v].limit.l1.l+"%");
                }else{
                    d3.select("#d4").text("< "+plotVarDef2[plotVar.v].limit.l4.r);
                    d3.select("#d3").text(plotVarDef2[plotVar.v].limit.l3.l +" - "+ plotVarDef2[plotVar.v].limit.l3.r);
                    d3.select("#d2").text(plotVarDef2[plotVar.v].limit.l2.l +" - "+plotVarDef2[plotVar.v].limit.l2.r);
    ...
    function Plot_Health_var_2_IndiaDistMAP(STATEDistrictTopo,stateAPIData){
          ...
          console.log("Checking the data : ",STATEDistrictTopo);
          dynamicPlotPercentage();
          //Sample data to plot will be deleted lat    
          function dynamicPlotPercentage()
            {
